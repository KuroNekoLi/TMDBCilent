package com.example.tmdbcilent.data.repository.movie

import android.util.Log
import com.example.tmdbcilent.data.model.movie.Movie
import com.example.tmdbcilent.data.repository.movie.datasource.MovieCacheDataSource
...
class MovieRepositoryImpl(
    ...
    suspend fun getMoviesFromAPI():List<Movie>{
        ...
        try{
            ...
            Log.i("LinLi", exception.message.toString());
        }
        return movieList
    }
